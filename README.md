...
* **Flexible Prompt Input:**
    * Interactive prompt entry via the terminal. (e.g., `./multirun.sh`)
    * Manual entry via the command line (e.g., `./multirun.sh "my prompt"`).
...
2.  **Enter prompt as a command line argument:**
    ```bash
